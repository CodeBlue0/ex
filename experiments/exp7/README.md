...
## Goal
- Base experiment: Exp6
- Keep per-feature normalization before gates:
...
## Outputs
- Same image/CSV set as Exp6, with suffix `_exp7_featnorm_twogate_backbone_diff_negb`.

## Run
```bash
python experiments/exp7/mnist_flat_dnn_gate_compare_exp7.py
```
